...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 279/279 backend (5 servicios Java + Node + Python), 126/126 web, 33/33 móvil \\
...
\texttt{vitest run}) dentro de \texttt{apps/web} (126); y \texttt{./gradlew
