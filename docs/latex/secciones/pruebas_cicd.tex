...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 239/239 backend (5 servicios Java + Node + Python), 94/94 web, 25/25 móvil \\
...
para los cinco servicios Java (38, 123, 35, 8 y 8 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (11); \texttt{pytest}
dentro de \texttt{services/ai-service} (16) — total backend, 239; \texttt{npm test} (que invoca
