...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 168/168 backend (5 servicios Java + Node + Python), 75/75 web, 5/5 móvil \\
...
para los cinco servicios Java (19, 106, 15, 8 y 8 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (4); \texttt{pytest}
dentro de \texttt{services/ai-service} (8) — total backend, 168; \texttt{npm test} (que invoca
