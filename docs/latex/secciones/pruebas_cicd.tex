...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 314/314 backend (5 servicios Java + Node + Python), 128/128 web, 33/33 móvil \\
...
para los cinco servicios Java (65, 155, 39, 8 y 16 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (15); \texttt{pytest}
dentro de \texttt{services/ai-service} (16) — total backend, 314; \texttt{npm test} (que invoca
...
La fila «Unitaria» no es una población disjunta de las filas «Integración» y «Contrato»: los 314
...
consumidor son 308~backend + 126~web + 33~móvil = 467; sumando las 4 de \texttt{Contrato} (2
...
sumar) da 467 + 4 + 6 = 477 pruebas automatizadas distintas en las tres capas inferiores de la
pirámide.
