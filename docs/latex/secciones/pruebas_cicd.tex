...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 207/207 backend (5 servicios Java + Node + Python), 94/94 web, 20/20 móvil \\
...
para los cinco servicios Java (31, 106, 31, 8 y 8 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (11); \texttt{pytest}
dentro de \texttt{services/ai-service} (12) — total backend, 207; \texttt{npm test} (que invoca
