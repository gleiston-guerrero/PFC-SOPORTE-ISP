...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 279/279 backend (5 servicios Java + Node + Python), 96/96 web, 33/33 móvil \\
...
\texttt{vitest run}) dentro de \texttt{apps/web} (96); y \texttt{./gradlew
