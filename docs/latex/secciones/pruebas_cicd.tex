...
y \texttt{services/report-service} para los tres servicios Java (15, 88 y 11 pruebas
respectivamente); \texttt{npm test} (que invoca \texttt{node --test}) dentro de
\texttt{services/notification-service} (4); \texttt{pytest} dentro de
\texttt{services/ai-service} (8) — total backend, 126; \texttt{npm test} (que invoca
