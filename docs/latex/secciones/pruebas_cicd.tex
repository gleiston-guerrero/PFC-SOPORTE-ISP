...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 262/262 backend (5 servicios Java + Node + Python), 94/94 web, 33/33 móvil \\
...
para los cinco servicios Java (54, 123, 35, 8 y 15 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (11); \texttt{pytest}
dentro de \texttt{services/ai-service} (16) — total backend, 262; \texttt{npm test} (que invoca
