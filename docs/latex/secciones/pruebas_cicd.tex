...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 200/200 backend (5 servicios Java + Node + Python), 85/85 web, 11/11 móvil \\
...
\texttt{vitest run}) dentro de \texttt{apps/web} (85); y \texttt{./gradlew
