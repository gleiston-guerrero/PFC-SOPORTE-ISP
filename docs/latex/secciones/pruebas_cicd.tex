...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 289/289 backend (5 servicios Java + Node + Python), 128/128 web, 33/33 móvil \\
...
para los cinco servicios Java (62, 140, 37, 8 y 15 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (11); \texttt{pytest}
dentro de \texttt{services/ai-service} (16) — total backend, 289; \texttt{npm test} (que invoca
