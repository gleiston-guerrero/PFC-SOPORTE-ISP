...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 235/235 backend (5 servicios Java + Node + Python), 94/94 web, 20/20 móvil \\
...
para los cinco servicios Java (38, 123, 31, 8 y 8 pruebas respectivamente); \texttt{npm test} (que
invoca \texttt{node --test}) dentro de \texttt{services/notification-service} (11); \texttt{pytest}
dentro de \texttt{services/ai-service} (16) — total backend, 235; \texttt{npm test} (que invoca
