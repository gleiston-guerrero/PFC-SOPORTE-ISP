...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 302/302 backend (5 servicios Java + Node + Python), 128/128 web, 33/33 móvil \\
...
dentro de \texttt{services/ai-service} (16) — total backend, 302; \texttt{npm test} (que invoca
