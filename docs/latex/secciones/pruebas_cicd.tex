...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 308/308 backend (5 servicios Java + Node + Python), 126/126 web, 33/33 móvil \\
...
\texttt{services/telemetry-service} para los cinco servicios Java da 65, 156, 39, 8 y 16 pruebas
respectivamente (284 en total); de las 156 de \texttt{svc-principal} se restan las 2 de
...
servicio real), y de las 65+39 de auth+report se restan las 2+2 de
\texttt{FlywayMigrationIntegrationTest} (mismo motivo) — 284 $-$ 2 $-$ 1 $-$ 2 $-$ 2 $=$ 277,
dejando 277 pruebas Java puramente unitarias; \texttt{npm test} dentro de
...
backend, 308. \texttt{npm test} (\texttt{vitest run}) dentro de \texttt{apps/web} da 128, de las
...
Sumando las tres filas ya disjuntas: 308 (Unitaria backend) + 126 (Unitaria web) + 33 (Unitaria
...
\textbf{477 pruebas automatizadas distintas} en las tres capas inferiores de la pirámide, sin
