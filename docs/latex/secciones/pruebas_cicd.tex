...
\midrule
Líneas & 692 & 716 & \textbf{96.6\,\%} \\
Instrucciones & 3392 & 3813 & 89.0\,\% \\
Ramas & 127 & 162 & 78.4\,\% \\
\bottomrule
\end{tabular}
\end{table}
...
la Entrega 3 (78.4\,\%, tras las rondas de pruebas de esta entrega). El paquete
...
\texttt{AuthGatewayFilterTest} (38 de 38 líneas cubiertas ahora). El paquete que más arrastra la
...
El reporte XML de JaCoCo agrega, a nivel de \texttt{<report>}, un total de 687/711 líneas —no
las 692/716 que resultan de sumar el CSV fila por fila. La diferencia no es un error de cálculo:
