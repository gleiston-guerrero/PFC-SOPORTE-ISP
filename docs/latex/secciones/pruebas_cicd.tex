...
integration, compile-latex]}, para que tampoco este artefacto se publique sin que los siete jobs
de verificación pasen primero.
...
en consecuencia: ahora es una versión real, no un alias fijo que solo indica "la más reciente".
