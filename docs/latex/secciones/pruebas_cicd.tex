...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 222/222 backend (5 servicios Java + Node + Python), 94/94 web, 20/20 móvil \\
...
dentro de \texttt{services/ai-service} (12) — total backend, 222; \texttt{npm test} (que invoca
