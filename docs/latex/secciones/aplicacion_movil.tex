...
procedimiento completo, incluida una limitación real declarada (el \texttt{trace\_id} de la
línea de \emph{log} capturada no se cruza con un registro de acceso del \emph{gateway}, así que
el emparejamiento con la captura de pantalla depende de la cercanía temporal, no de una cadena de
trazas verificable de punta a punta).
