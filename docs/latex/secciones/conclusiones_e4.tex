...
\texttt{python scripts/aporte\_manuscrito.py docs/latex/ --commit 3652545e98c98c6216b8d97d8ed2f2e7212d61cb}.
...
\midrule
Backend (\texttt{services/}) & \textbf{J. Álvarez 31,75\,\%}, C. Pacheco 29,81\,\%, C. Carpio 20,12\,\%, R. Cando 18,33\,\% \\
Aplicación web (\texttt{apps/web/}) & C. Carpio 82,39\,\%, J. Álvarez 17,61\,\% \\
Aplicación móvil (\texttt{apps/mobile/}) & R. Cando 71,53\,\%, J. Álvarez 26,74\,\%, C. Carpio 1,73\,\% \\
Manuscrito (\texttt{docs/latex/}) & C. Pacheco 57,27\,\%, J. Álvarez 23,41\,\%, R. Cando 11,71\,\%, C. Carpio 7,61\,\% \\
Experimentos (\texttt{experimentos/}, \texttt{spark/}) & R. Cando 73,74\,\%, C. Pacheco 17,70\,\%, C. Carpio 5,19\,\%, J. Álvarez 3,37\,\% \\
Observabilidad (\texttt{ops/}) & C. Pacheco 97,09\,\%, J. Álvarez 2,91\,\% \\
CI/CD (\texttt{.github/}) & C. Carpio 57,23\,\%, J. Álvarez 32,45\,\%, C. Pacheco 5,41\,\%, R. Cando 4,91\,\% \\
Arquitectura (\texttt{docs/adr/}, \texttt{docs/diagrams/}) & \textbf{J. Álvarez 57,48\,\%}, C. Pacheco 17,67\,\%, R. Cando 12,77\,\%, C. Carpio 12,07\,\% \\
...
\texttt{python scripts/aporte\_manuscrito.py <rutas> --commit 3652545e98c98c6216b8d97d8ed2f2e7212d61cb},
el último commit antes de esta misma corrección (el commit de esta propia corrección no se usa
como referencia porque medirse a sí mismo es circular; una revisión externa encontró que la
referencia anterior, \texttt{ceae7375}, ya llevaba 37 commits de atraso frente a la entrega real
para cuando se evaluó). Las líneas de dependencias y de artefactos generados quedan fuera del
...
\begin{itemize}[nosep]
  ...
  \item Cobertura de pruebas de \texttt{ticket-service} en 96.7\,\% de líneas propias (por
